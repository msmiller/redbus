...
# @Last Modified time: 2019-11-01 21:42:56
#
...
class RedisBus
  ...
  CACHETHRU_DEBUG_ON = true
    ...
    def deposit(item, rpc_token=nil, expire_at=nil, serialized=nil)
      base_redis_key = RedisBus::_base_redis_key(item)
      redis_key = RedisBus::_redis_key(item)
    ...
    def retrieve(item_class, item_id, channel, expire_at=nil)
      ...
      base_redis_key = RedisBus::_base_redis_key( {class: item_class, id: item_id} )
      redis_key = RedisBus::_redis_key( {class: item_class, id: item_id} )
